        ...
        <div class="weatherDetails">
            <div class="weatherIcon">
                ...
                <h2>${temperature[2]} °C</h2>
                 <input type="hidden" id="wc" value="${weatherCondition[2]}"> </input>
            </div>
...
<table border="1" bgcolor="yellowgreen">
    ...
    <% 
        ...
        int[] temperatures = (int[]) request.getAttribute("temperature");
        String[] weatherConditions = (String[]) request.getAttribute("weatherCondition");
        int[] humidities = (int[]) request.getAttribute("humidity");
        double[] windSpeeds = (double[]) request.getAttribute("windSpeed");
